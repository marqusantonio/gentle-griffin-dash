  ...
  const buildConversationsFromDms = (
    ...
    dms.forEach((dm) => {
      ...
      const chatMsg: ChatMessage = {
        ...
        type: (dm.type as any) || (dm.media<dyad-write path="src/context/WevidsContext.tsx" description="Complete WevidsContext and WevidsProvider implementation without truncation">
import React, { createContext, useContext, useReducer, useEffect, ReactNode, useCallback } from 'react';
import { wevidsReducer, initialWevidsState, WevidsState } from './wevidsReducer';
import { 
  PostItem, 
