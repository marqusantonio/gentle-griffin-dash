...
import { Radio, ShieldAlert, Check, X, Lock, Loader2 } from 'lucide-react';
...
export const MessageRequestBanner: React.FC<MessageRequestBannerProps> = ({
  ...
  return (
    <div className="p-4 rounded-3xl bg-gradient-to-r from-[#030712] via-[#0f172a] to-[#030712] border border-[#06b6d4]/40 shadow-[0_0_30px_rgba(6,182,212,0.25)] space-y-3 relative overflow-hidden backdrop-blur-xl animate-fade-in">
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 rounded-full bg-[#06b6d4]/20 border border-[#06b6d4]/40 text-[#06b6d4] font-orbitron font-bold text-[9px] flex items-center gap-1">
                <Radio className="w-2.5 h-2.5 animate-pulse text-[#a855f7]" />
            ...
            <div className="text-xs font-bold text-white mt-1">
              <span className="text-[#06b6d4]">{senderName}</span> wants to connect and send messages.
            </div>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto justify-end relative z-10">
          ...
          <button
            ...
            disabled={isProcessing}
            className="px-4 py-2 rounded-xl bg-gradient-to-r from-[#06b6d4] to-[#a855f7] text-slate-950 font-orbitron font-bold text-[10px] shadow-[0_0_20px_rgba(6,182,212,0.6)] flex items-center gap-1.5 transition-all hover:scale-105"
          >
            {isProcessing ? (
